    ...
    data.forEach(({ className, probability }) => {
        ...
        if (strPercentage == "100%")
        {
          if(className=="CStand")
          {
            ...
            if(AccurateStateTracker.includes("WLMarch") || AccurateStateTracker.includes("WRMarch"))
            {
              AccurateStateTracker = [];
            }
            else if(AccurateStateTracker.includes("LMarch") || AccurateStateTracker.includes("RMarch"))
            {
